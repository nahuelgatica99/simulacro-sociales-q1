...
const BANCO_PREGUNTAS = [
    // 1. LOS AMBIENTES Y SUS RECURSOS NATURALES (15 preguntas)
    ...
    { q: "¿Qué ejemplo de relieve transformado menciona el libro en Buenos Aires?", o: ["El Obelisco", "Barrancas de Belgrano", "Reserva Ecológica"], c: 1, e: "Las barrancas muestran lomas naturales transformadas con especies exóticas.", h: "Relieves elevados o lomas.", t: "Ambientes y Recursos" },
    { q: "¿Por qué los humanos somos 'agentes de transformación'?", o: ["Porque miramos", "Porque modificamos el entorno para vivir", "Porque no cambiamos nada"], c: 1, e: "Cada actividad humana (vivienda, caminos) cambia el ambiente original.", h: "Acción humana.", t: "Ambientes y Recursos" },
    { q: "Un recurso natural es considerado 'social' porque:", o: ["Es de todos", "La sociedad decide cómo y para qué usarlo", "Se vende en el mercado"], c: 1, e: "La valoración social es la que convierte a un elemento natural en recurso.", h: "Depende de la valoración.", t: "Ambientes y Recursos" },
    ...
    { q: "El uso de un recurso puede mejorar la vida, por ejemplo:", o: ["Al contaminar", "Al construir una vivienda", "Al talar todo"], c: 1, e: "La transformación ambiental no siempre es negativa, satisface necesidades básicas.", h: "Ejemplo positivo.", t: "Ambientes y Recursos" },
    { q: "La biodiversidad se refiere a:", o: ["Muchos edificios", "Variedad de seres vivos en un ambiente", "La cantidad de agua"], c: 1, e: "Es la riqueza de especies vegetales y animales de un lugar.", h: "Vida variada.", t: "Ambientes y Recursos" },
    { q: "El concepto de ambiente actualmente afecta a:", o: ["Solo ciudades", "Todo el planeta", "Solo el campo"], c: 1, e: "Las transformaciones humanas hoy tienen un alcance global.", h: "Escala mundial.", t: "Ambientes y Recursos" },
    { q: "¿Qué recurso es vital para alimentarnos y producir herramientas?", o: ["Recursos naturales", "Solo el dinero", "El plástico"], c: 0, e: "La naturaleza provee la base de toda nuestra producción.", h: "Base de la vida.", t: "Ambientes y Recursos" },
    { q: "Las lomas de Belgrano son un desnivel del terreno llamado:", o: ["Montaña", "Relieve", "Meseta"], c: 1, e: "El relieve es la forma natural de la superficie terrestre.", h: "Forma de la tierra.", t: "Ambientes y Recursos" },
    ...
    { q: "El manejo de los recursos depende de:", o: ["El clima", "Las decisiones de la sociedad", "La suerte"], c: 1, e: "Cada sociedad decide cómo explotar o cuidar su entorno.", h: "Decisión humana.", t: "Ambientes y Recursos" },
    { q: "La transformación ambiental por desconocimiento es:", o: ["Intencional", "Accidental", "Natural"], c: 1, e: "A veces dañamos el ambiente sin saber las consecuencias.", h: "Sin intención.", t: "Ambientes y Recursos" },
    ...
    // 2. TIPOS DE RECURSOS: RENOVABLES Y NO RENOVABLES (14 preguntas)
    { q: "¿Qué define a los recursos renovables?", o: ["No se usan", "Se regeneran en tiempos cortos", "Tardan siglos"], c: 1, e: "Tienen ciclos naturales que coinciden con el tiempo humano.", h: "Ciclos cortos.", t: "Tipos de Recursos" },
    { q: "¿Cuál es un recurso no renovable?", o: ["Energía solar", "Petróleo y minerales", "Madera"], c: 1, e: "Se agotan porque su formación tarda millones de años.", h: "Tardan mucho.", t: "Tipos de Recursos" },
    ...
    { q: "La energía eólica usa un recurso:", o: ["No renovable", "Renovable (viento)", "Caro"], c: 1, e: "El viento es un recurso que no se agota con su uso.", h: "Inagotable.", t: "Tipos de Recursos" },
    { q: "Si usamos un recurso renovable más rápido de lo que se repone:", o: ["Se multiplica", "Puede agotarse", "Mejora"], c: 1, e: "La sobreexplotación rompe el ciclo de renovación natural.", h: "Uso excesivo.", t: "Tipos de Recursos" },
    ...
    { q: "¿Qué recurso es inagotable o perpetuo?", o: ["Agua dulce", "Energía solar", "Gas"], c: 1, e: "El sol siempre está disponible sin importar cuánto usemos su energía.", h: "Siempre disponible.", t: "Tipos de Recursos" },
    { q: "Los animales (fauna) son recursos renovables si:", o: ["Se cazan todos", "Se respeta su ciclo de reproducción", "Viven en zoos"], c: 1, e: "Permitir que nazcan nuevas crías asegura el recurso.", h: "Respetar tiempos.", t: "Tipos de Recursos" },
    ...
    { q: "El agua dulce es un recurso que debemos cuidar porque:", o: ["Es salada", "Es limitada para el consumo humano", "Es infinita"], c: 1, e: "Aunque hay mucha agua, solo una pequeña parte es potable.", h: "Escasez.", t: "Tipos de Recursos" },
    ...
    { q: "¿Qué significa manejo sustentable?", o: ["Gastar todo", "Usar hoy cuidando el futuro", "No tocar nada"], c: 1, e: "Es el equilibrio entre desarrollo y conservación.", h: "Pensar en el mañana.", t: "Tipos de Recursos" },
    { q: "Los diamantes son recursos:", o: ["No renovables", "Renovables", "Plásticos"], c: 0, e: "Son minerales que tardan millones de años en formarse bajo tierra.", h: "Mineral precioso.", t: "Tipos de Recursos" },
    ...
    // 3. ACTORES SOCIALES Y EL ESTADO (14 preguntas)
    { q: "¿Quiénes son los actores sociales?", o: ["Solo políticos", "Personas y grupos que intervienen en el ambiente", "Los animales"], c: 1, e: "Son grupos con intereses específicos (empresas, vecinos, ONGs).", h: "Grupos de interés.", t: "Actores Sociales" },
    { q: "El actor social encargado de crear leyes es:", o: ["Las empresas", "El Estado", "Las ONGs"], c: 1, e: "El Estado regula el uso de los recursos mediante normas.", h: "Poder legislativo.", t: "Actores Sociales" },
    ...
    { q: "Las empresas privadas buscan principalmente:", o: ["Plantar flores", "Obtener rentabilidad económica", "No usar recursos"], c: 1, e: "Su interés es producir y ganar dinero con el recurso.", h: "Ganancia.", t: "Actores Sociales" },
    ...
    { q: "El Estado controla el ambiente mediante:", o: ["Regalos", "Inspecciones y multas", "Fotos"], c: 1, e: "Debe vigilar que se cumplan las leyes ambientales.", h: "Control público.", t: "Actores Sociales" },
    { q: "Las asambleas vecinales suelen luchar contra:", o: ["El sol", "Problemas ambientales locales", "La música"], c: 1, e: "Se organizan para frenar daños en su barrio.", h: "Organización local.", t: "Actores Sociales" },
    { q: "Los científicos aportan a los actores sociales:", o: ["Dinero", "Información y conocimiento", "Maquinaria"], c: 1, e: "Ayudan a entender si una actividad es peligrosa.", h: "Saber científico.", t: "Actores Sociales" },
    { q: "El derecho a un ambiente sano está en:", o: ["La guía de teléfono", "La Constitución Nacional", "Los cuentos"], c: 1, e: "Es un derecho fundamental de todos los habitantes.", h: "Ley máxima.", t: "Actores Sociales" },
    { q: "Un conflicto ambiental en Argentina es:", o: ["El frío", "Las papeleras o minería", "El fútbol"], c: 1, e: "Son temas donde Estado, empresas y vecinos suelen discutir.", h: "Temas de disputa.", t: "Actores Sociales" },
    ...
    { q: "La gestión ambiental es responsabilidad de:", o: ["Solo vecinos", "Principalmente del Estado", "Nadie"], c: 1, e: "El Estado organiza cómo se cuida el entorno.", h: "Responsabilidad pública.", t: "Actores Sociales" },

    // 4. PROBLEMAS AMBIENTALES (15 preguntas)
    ...
    { q: "Un problema de escala LOCAL es:", o: ["Cambio climático", "Basural en un barrio", "Agujero de ozono"], c: 1, e: "Solo afecta a una zona pequeña o comunidad.", h: "Espacio reducido.", t: "Problemas Ambientales" },
    { q: "La deforestación se hace para obtener:", o: ["Solo sombra", "Tierras para agricultura o ganadería", "Aire puro"], c: 1, e: "Se talan bosques para cambiar el uso del suelo.", h: "Agronegocio.", t: "Problemas Ambientales" },
    { q: "Un problema ambiental GLOBAL afecta a:", o: ["Un vecino", "Todo el planeta", "Un solo país"], c: 1, e: "Sus causas y efectos son mundiales.", h: "Escala mundial.", t: "Problemas Ambientales" },
    ...
    { q: "El calentamiento global es causado por:", o: ["El frío", "Aumento de gases de invernadero", "Las estrellas"], c: 1, e: "Gases como el CO2 atrapan el calor del sol.", h: "Gases de fábricas.", t: "Problemas Ambientales" },
    { q: "La pérdida de biodiversidad significa:", o: ["Más flores", "Menos especies de plantas y animales", "Viajar más"], c: 1, e: "Se extinguen seres vivos por daño ambiental.", h: "Extinción.", t: "Problemas Ambientales" },
    ...
    { q: "Los agrotóxicos afectan principalmente:", o: ["El espacio", "Suelo y agua cerca de campos", "La luna"], c: 1, e: "Químicos usados en el campo que pueden enfermar.", h: "Química agrícola.", t: "Problemas Ambientales" },
    { q: "Un problema ambiental puede ocurrir por:", o: ["Solo accidentes", "Accidentes o acciones intencionales", "Mala suerte"], c: 1, e: "A veces es descuido y otras es por ganar dinero.", h: "Causas humanas.", t: "Problemas Ambientales" },
    { q: "La basura tecnológica es un problema porque:", o: ["Es vieja", "Tiene metales tóxicos", "No sirve"], c: 1, e: "Celulares y pilas contaminan mucho si no se reciclan.", h: "Electrónica.", t: "Problemas Ambientales" },
    { q: "El cambio climático provoca:", o: ["Clima estable", "Fenómenos extremos (sequías, inundaciones)", "Más hielo"], c: 1, e: "Desequilibra las lluvias y temperaturas del mundo.", h: "Clima extremo.", t: "Problemas Ambientales" },
    { q: "La contaminación auditiva es producida por:", o: ["Silencio", "Ruidos excesivos de autos y fábricas", "Música suave"], c: 1, e: "El ruido excesivo daña la salud mental.", h: "Mucho ruido.", t: "Problemas Ambientales" },
    { q: "Reciclar ayuda a reducir:", o: ["La inteligencia", "La acumulación de residuos", "El viento"], c: 1, e: "Menos basura significa menos contaminación.", h: "Las 3 R.", t: "Problemas Ambientales" },

    // 5. AMENAZAS Y RIESGOS NATURALES (14 preguntas)
    ...
    { q: "Una amenaza de origen INTERNO es:", o: ["Tornado", "Terremoto y erupción volcánica", "Lluvia"], c: 1, e: "Vienen del interior de la corteza terrestre.", h: "Desde adentro.", t: "Amenazas y Riesgos" },
    ...
    { q: "¿Qué causa un tsunami?", o: ["Mucho sol", "Terremotos submarinos", "Viento"], c: 1, e: "El suelo marino se mueve y desplaza el agua.", h: "Olas gigantes.", t: "Amenazas y Riesgos" },
    { q: "Las sequías se desarrollan:", o: ["En un segundo", "Lentamente por falta de lluvia", "Solo en invierno"], c: 1, e: "Es la falta de precipitaciones por mucho tiempo.", h: "Poco a poco.", t: "Amenazas y Riesgos" },
    ...
    { q: "Las sudestadas afectan principalmente a:", o: ["Mendoza", "Ciudad de Buenos Aires", "San Juan"], c: 1, e: "Viento y lluvia que inundan la zona ribereña.", h: "Río de la Plata.", t: "Amenazas y Riesgos" },
    ...
    { q: "Un tornado es un viento:", o: ["Recto", "Giratorio en forma de embudo", "Suave"], c: 1, e: "Es un remolino de aire muy violento.", h: "Gira rápido.", t: "Amenazas y Riesgos" },
    { q: "Las inundaciones pueden ocurrir por:", o: ["Falta de nubes", "Lluvias intensas o desborde de ríos", "Mucho calor"], c: 1, e: "El agua cubre terrenos que suelen estar secos.", h: "Mucha agua.", t: "Amenazas y Riesgos" },
    { q: "Las olas de calor afectan principalmente:", o: ["Los edificios", "La salud de personas y cultivos", "Las piedras"], c: 1, e: "Temperaturas extremas que pueden ser peligrosas.", h: "Mucho calor.", t: "Amenazas y Riesgos" },
    ...
    { q: "El granizo puede dañar:", o: ["Solo el agua", "Autos y cultivos", "El sol"], c: 1, e: "Son piedras de hielo que caen con fuerza.", h: "Hielo cayendo.", t: "Amenazas y Riesgos" },
    { q: "La nieve excesiva puede causar:", o: ["Sequía", "Aislamiento de pueblos y avalanchas", "Calor"], c: 1, e: "Corta rutas y bloquea accesos.", h: "Mucha nieve.", t: "Amenazas y Riesgos" },

    // 6. VULNERABILIDAD Y DESASTRES (14 preguntas)
    ...
    { q: "Un desastre ocurre cuando:", o: ["Llueve normal", "Amenaza natural + Sociedad vulnerable", "No hay gente"], c: 1, e: "Si la gente está preparada, el fenómeno no es desastre.", h: "Peligro + Debilidad.", t: "Vulnerabilidad y Desastres" },
    { q: "Los edificios antisísmicos sirven para:", o: ["Gastar", "Reducir la vulnerabilidad ante sismos", "Atraer nubes"], c: 1, e: "Evitan el derrumbe y salvan vidas.", h: "Construcción segura.", t: "Vulnerabilidad y Desastres" },
    ...
    { q: "¿Por qué un sismo en Japón mata menos que en Haití?", o: ["Por suerte", "Por mejor preparación y normas de construcción", "No hay sismos"], c: 1, e: "La inversión en seguridad baja la vulnerabilidad.", h: "Mejor protegidos.", t: "Vulnerabilidad y Desastres" },
    { q: "Un mapa de riesgo sirve para:", o: ["Encontrar tesoros", "Saber qué zonas son peligrosas para vivir", "Pintar"], c: 1, e: "Ayuda a no construir casas en lugares inundables.", h: "Identificar peligro.", t: "Vulnerabilidad y Desastres" },
    { q: "La educación ambiental sirve para:", o: ["Nada", "Saber cómo actuar ante emergencias", "Ser más alto"], c: 1, e: "Estar informados nos hace menos vulnerables.", h: "Saber es prevenir.", t: "Vulnerabilidad y Desastres" },
    ...
    { q: "Vivir en un terreno inundable es:", o: ["Divertido", "Una situación de alta vulnerabilidad", "Seguro"], c: 1, e: "Te expone directamente a la amenaza del agua.", h: "Lugar inseguro.", t: "Vulnerabilidad y Desastres" },
    { q: "Después de un desastre, la reconstrucción debe:", o: ["Ser igual", "Ser más segura y planificada", "No hacerse"], c: 1, e: "Hay que aprender para no ser vulnerables de nuevo.", h: "Aprender.", t: "Vulnerabilidad y Desastres" },
    ...
    { q: "Un desastre afecta más a:", o: ["Los que tienen refugio", "Las personas más pobres y vulnerables", "Nadie"], c: 1, e: "La falta de recursos impide recuperarse rápido.", h: "Desigualdad.", t: "Vulnerabilidad y Desastres" },

    // 7. EL AIRE Y LA ATMÓSFERA (14 preguntas)
    ...
    { q: "El gas más abundante en el aire es:", o: ["Oxígeno", "Nitrógeno (78%)", "Argón"], c: 1, e: "El nitrógeno es el componente principal.", h: "78 por ciento.", t: "Aire y Atmósfera" },
    { q: "El oxígeno es necesario para:", o: ["La fotosíntesis", "La respiración de los seres vivos", "Hacer fuego nada más"], c: 1, e: "Sin oxígeno no hay vida animal ni humana.", h: "Respiración.", t: "Aire y Atmósfera" },
    { q: "La presión atmosférica es:", o: ["El calor", "El peso del aire sobre la superficie", "La lluvia"], c: 1, e: "El aire pesa y la gravedad lo empuja hacia abajo.", h: "Peso del aire.", t: "Aire y Atmósfera" },
    ...
    { q: "La capa de ozono nos protege de:", o: ["El frío", "Los rayos ultravioletas (UV)", "La lluvia"], c: 1, e: "Actúa como un filtro solar natural.", h: "Filtro solar.", t: "Aire y Atmósfera" },
    { q: "El aire caliente tiende a:", o: ["Bajar", "Subir", "Quedarse quieto"], c: 1, e: "Es menos denso y más liviano que el aire frío.", h: "Sube.", t: "Aire y Atmósfera" },
    ...
    { q: "¿Qué gas expulsamos al respirar?", o: ["Oxígeno", "Dióxido de Carbono (CO2)", "Helio"], c: 1, e: "Es el residuo de nuestra respiración.", h: "CO2.", t: "Aire y Atmósfera" },
    ...
    { q: "La contaminación del aire produce:", o: ["Lluvia de colores", "Enfermedades respiratorias y smog", "Más oxígeno"], c: 1, e: "Los gases tóxicos dañan los pulmones.", h: "Smog.", t: "Aire y Atmósfera" },
    { q: "El aire es materia porque:", o: ["Es espiritual", "Tiene masa y ocupa lugar", "No se ve"], c: 1, e: "Aunque sea invisible, pesa y ocupa volumen.", h: "Masa y volumen.", t: "Aire y Atmósfera" },
...
function mainMenu() {
  ...
  document.getElementById('action-buttons').innerHTML = `
    <button onclick="startAventura()" style="background:#2563eb">🚀 INICIAR SIMULACRO SOCIALES</button>
